...
/**
 * List of phone images to use in reviews
 */
const PHONES = [
  "/testimonials/1.jpg",
  "/testimonials/2.jpg",
...
/**
 * Split an array into `numParts` parts
 */
...
/**
 * A column of reviews that marquee up , add in tailwind.config.js
 */
...
/**
 * A review component that fades in
 */
...
/**
 *  A grid of reviews that marquee up and fade in as they come into view
 */
function ReviewGrid() {
